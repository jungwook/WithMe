 ...
 */
typedef NS_ENUM (NSUInteger, MultiColumnLayoutItemRenderDirection) {
  MultiColumnLayoutItemRenderDirectionShortestFirst,
  MultiColumnLayoutItemRenderDirectionLeftToRight,
  MultiColumnLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const MultiColumnElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const MultiColumnElementKindSectionFooter;

#pragma mark - MultiColumnDelegateLayout

@class MultiColumnLayout;

/**
 *  The MultiColumnDelegateLayout protocol defines methods that let you coordinate with a
 *  MultiColumnLayout object to implement a waterfall-based layout.
 ...
 */
@protocol MultiColumnDelegateLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - MultiColumnLayout

/**
 *  The MultiColumnLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `MultiColumnDelegateLayout` protocol.
 *
 ...
 *
 *  @note MultiColumnLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface MultiColumnLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (MultiColumnLayoutItemRenderDirectionLeftToRight), right to left (MultiColumnLayoutItemRenderDirectionRightToLeft), or shortest column fills first (MultiColumnLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: MultiColumnLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) MultiColumnLayoutItemRenderDirection itemRenderDirection;
