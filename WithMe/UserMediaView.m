...
- (void)awakeFromNib
{
    ...
    self.timePerImage = self.timePerImage ? : kKBDefaultTimePerImage + ((int) (arc4random()%15)) - 7.5;
...
- (void)changeImage
{
    ...
    } else if (self.mainImage) {
        [self setImage:self.mainImage];
    }
